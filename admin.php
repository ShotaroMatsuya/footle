                                ...
                                <fieldset class="form-group">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="crawlSite" value="https://www.goal.com/en/" checked> Goal.com
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" name="crawlSite" class="form-check-input" value="https://onefootball.com/en/home"> one-football
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" name="crawlSite" class="form-check-input" value="https://www.bbc.com/sport/football"> BBC for football
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
