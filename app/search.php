        ...
        <div class="searchContainer">
          ...
          <form action="search.php" method="GET" id="search-form" name="search-form">
            ...
            <div class="searchBarContainer">
              ...
              <button class="searchButton" type="submit" id="search-btn" name="search-btn"><img
                  src="assets/images/icons/search.png"></button>
            </div>
          </form>
          ...
          <form action="search.php" method="GET">
            ...
            <div class="searchBarContainer">
              ...
              <button class="searchButton" type="submit" id="searchBtn"><img
                  src="assets/images/icons/search.png"></button>
            </div>
          </form>
          <?php } ?>
